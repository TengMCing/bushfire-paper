...
Knowing the precise ignition location and ignition time will allow us to reconstruct detailed information at the time, such as weather condition and the distribution of vegetation. This can provide some help in understanding the cause of bushfires.
...
The general choice for bushfire modelling is the generalised additive model (**GAM**). For example, @read2018lightning used **GAM** to model the risk of lightning-caused bushfires in Victoria. In this research, a spectrum of statistical models have been explored as the classifier to predict the cause of bushfire, including **GAM**, and other computationally intensive models which are popular in the field of modern machine learning but rarely used in bushfire modelling. Our final model can be used to produce the prediction of the cause of 2019-2020 Australia bushfires. To our knowledge, there is not yet any academic research on modelling and predicting the cause of this bushfire season.
