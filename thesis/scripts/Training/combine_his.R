...
weather_o <- read_csv("data/weather.csv")
...
rm(trim_fire_o)
unlink("data/Near-surface_Wind_Speed/mcvicar_etal_grl2008/2deg/unzip",
       recursive = TRUE)
unlink("data/Near-surface_Wind_Speed/mcvicar_etal_grl2008/2deg/unzip_m",
       recursive = TRUE)
...
write.csv(fire_o, "data/training.csv", row.names = FALSE)
