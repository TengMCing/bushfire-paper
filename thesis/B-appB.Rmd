...
(ref:hpgridtwodetail) A description of each hyperparameter. The definition of the hyperparameters is referenced from the documentations of the package `nnet` [@nnet], package `randomForest`[@R-rf] and package `xgboost` [@xgboost].
