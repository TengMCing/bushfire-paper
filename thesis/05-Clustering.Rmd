...
This step starts from the second interval $\boldsymbol{S}_2$ till the interval $\boldsymbol{S}_T$. Given the interval $\boldsymbol{S}_t$, the algorithm will:
