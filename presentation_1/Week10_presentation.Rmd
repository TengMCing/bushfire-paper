...
---
# Project design
## Clustering - 2. The alogrithm start from the first hour
...
---
# Project design
## Clustering - 4. Create a new group for each <u>connected</u> graph and compute centroid

<img src="images/gif/h1-3-1.jpg" style="width:80%">

---
# Project design
## Clustering - 5. Next, the alogrithm select the hotspots in the second hour
