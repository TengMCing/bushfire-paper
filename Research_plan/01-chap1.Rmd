...
This research aims to answer the following questions:
  ...
  1. How to find the ignition methods during 2019-2020 Australia bushfire season?
    How to identify fire from hotspots data?
    How to classify the cause of ignition without classes labels?
    Will likelihood of ignitions increase near the campping site and road?
    Will likelihood of ignitions increase near lightning strikes?
  2. How to model fire risk of neighbourhoods?
    Are tree-based models better than Generalized linear model and Generalized additive model in fire risk prediction?
    How to take into account the temporal patterns and spatial patterns in fire risk modelling?
