...
<!-- Data types -->
The hotspot data is csv format, which can be processed generally with the tidyverse tools (Hadley et al., 2020) in R. Map data is presented as geospatial object, which can be processed using the tools in the `sf` (Edzer, 2020). Weather?
