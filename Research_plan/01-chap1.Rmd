...
Most of the existing works of bushfire ignition analysis focus on a certain area such as south-eastern Australia (Clarke et al., 2019), or a certain state such as Victoria (Read, Duff & Taylor, 2018). In this research, we will primarily focus on Victoria but eventually extend the results throughout Australia. In addition, little research has been done in analysing the cause of 2019-2020 bushfires. Due to unknown causes of 2019-2020 bushfires, clustering, which is a rarely considered method in this field, will be used to identify ignition types.
