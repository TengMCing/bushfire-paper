...
It is expected that we will have probabilistic predictions for ignition cause for the 2019-2020 for each of the fires identified from the hotspot data. A useable model of fire risk will be produced and made accessible in  an interactive web application.
